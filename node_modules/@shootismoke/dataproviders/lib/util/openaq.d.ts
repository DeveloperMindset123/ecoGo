...
declare type entity = 'community' | 'government' | 'research' | 'other';
/**
 ...
 * @ignore
 */
export declare type OpenAQErrorObject = {
    detail: {
        loc: string[];
        msg: string;
        type: string;
 ...
 */
export declare type OpenAQError = string | {
    detail: {
        loc: string[];
        msg: string;
        type: string;
