...
function checkError(_a) {
    var status = _a.status, data = _a.data, msg = _a.msg;
...
function fetchByGps(gps, options) {
    ...
    var latitude = gps.latitude, longitude = gps.longitude;
    return (0, fetch_1.fetchAndDecode)("https://api.waqi.info/feed/geo:".concat(latitude, ";").concat(longitude, "/?token=").concat(options.token)).then(checkError);
}
...
function fetchByStation(stationId, options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, (0, fetch_1.fetchAndDecode)("https://api.waqi.info/feed/@".concat(stationId, "/?token=").concat(options.token)).then(checkError)];
        });
    });
}
